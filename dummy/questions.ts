...
import { Question, Project, Tag } from "@/types";
...
export const users = [
  ...
  },
  {
    ...
    platforms: ["Facebook", "X", "Stack Overflow", "TikTok", "Dropbox"],
  },
  {
    id: 6436184,
    name: "Peter Smith",
    ...
    education: "XYZ University",
    platforms: ["X", "YouTube", "TikTok", "Reddit", "Codepen"],
  },
  {
    id: 5460166,
    name: "Mary Jones",
    ...
    education: "ABC College",
    platforms: ["Reddit", "X", "Dropbox", "Twitch", "GitHub"],
  },
  {
    id: 8973098,
    name: "Susan Brown",
  ...
  },
  {
    ...
    education: "ABC College",
    platforms: ["Twitch", "Discord", "Codepen", "X", "Medium"],
  },
  {
    id: 1691053,
    name: "Emily Johnson",
    ...
    education: "XYZ University",
    platforms: ["Twitch", "X", "LinkedIn", "YouTube", "TikTok"],
  },
  {
    id: 9601998,
    name: "Robert Wilson",
  ...
  },
  {
    ...
    name: "Elon Musk",
    about:
      "Hello there, fellow coders! I'm Elon Musk, founder of SpaceX, Tesla, and Neuralink, among other things. When I'm not launching rockets or working on sustainable energy solutions, you can find me diving deep into the world of code. From AI to electric vehicles, I believe that coding is the language of the future. Join me in exploring the cutting edge of tech, and together, we can change the world, one line of code at a time!",
    email: "elonmusk@example.com",
    position: "Chief Executive Officer",
    fileAttachments: [],
    codingLanguages: [
      { language: "Python", proficiency: 100 },
      { language: "C++", proficiency: 100 },
      { language: "C", proficiency: 100 },
      { language: "Java", proficiency: 100 },
      { language: "JavaScript", proficiency: 100 },
      { language: "HTML", proficiency: 100 },
      { language: "CSS", proficiency: 100 },
      { language: "SQL", proficiency: 100 },
      { language: "PyTorch", proficiency: 100 },
      { language: "React", proficiency: 100 },
      { language: "React Native", proficiency: 100 },
      { language: "Ruby", proficiency: 100 },
      { language: "ChatGPT", proficiency: 100 },
    ],
    isOnline: varStatus(),
    location: "San Francisco",
    company: "X",
  ...
  },
  {
    ...
    name: "Bill Gates",
    about:
      "I'm a software engineer and philanthropist. I'm the co-founder of Microsoft, and I've been passionate about coding since I was a kid. I believe that coding is a powerful tool that can be used to solve some of the world's biggest problems. I want to learn from other programmers and share my own knowledge. I'm always looking for new ways to improve my skills, and I'm always excited to help others.",
    ...
    codingLanguages: [
      ...
      { language: "C++", proficiency: 100 },
      { language: "SQL", proficiency: 100 },
      { language: "Microsoft SQL Server", proficiency: 100 },
      { language: "TypeScript", proficiency: 100 },
      { language: "Bash", proficiency: 100 },
      { language: "Git", proficiency: 100 },
      { language: "GitHub", proficiency: 100 },
      { language: "C", proficiency: 100 },
      { language: "PHP", proficiency: 100 },
      { language: ".NET", proficiency: 100 },
      { language: "Azure", proficiency: 100 },
      { language: "VS Code", proficiency: 100 },
      { language: "Windows", proficiency: 100 },
    ],
    isOnline: varStatus(),
    location: "Seattle",
    company: "Microsoft",
  ...
  },
  {
    ...
    codingLanguages: [
      { language: "React", proficiency: 100 },
      { language: "React Native", proficiency: 100 },
      { language: "GraphQL", proficiency: 100 },
      { language: "PyTorch", proficiency: 100 },
    ],
    isOnline: varStatus(),
    location: "Menlo Park",
  ...
  },
  {
    ...
    name: "Immanuel Peter",
    about:
      "Hey everybody! My name is Immanuel Peter, and I am passionate about the partnership between coding and collaboration. That's why I developed CodingOH: to provide a decentralized platform for developers to get direct answers to their specific problems. Let's make this platform great!",
    email: "immanuel.peter1@gmail.com",
    position: "Co-founder & CEO",
    fileAttachments: ["resume.pdf"],
    codingLanguages: [
      { language: "Python", proficiency: 85 },
      { language: "R", proficiency: 4 },
      { language: "SQL", proficiency: 35 },
      { language: "MySQL", proficiency: 25 },
      { language: "TensorFlow", proficiency: 28 },
      { language: "Git", proficiency: 37 },
      { language: "GitHub", proficiency: 38 },
      { language: "Swift", proficiency: 34 },
      { language: "HTML", proficiency: 26 },
      { language: "CSS", proficiency: 14 },
      { language: "Tailwind CSS", proficiency: 43 },
      { language: "C++", proficiency: 13 },
      { language: "Java", proficiency: 50 },
      { language: "Bash", proficiency: 29 },
      { language: "JavaScript", proficiency: 80 },
      { language: "Kotlin", proficiency: 17 },
      { language: "jQuery", proficiency: 24 },
      { language: "Node.js", proficiency: 35 },
      { language: "React", proficiency: 70 },
      { language: "React Native", proficiency: 50 },
      { language: "Next.js", proficiency: 50 },
      { language: "Redux", proficiency: 25 },
      { language: "TypeScript", proficiency: 65 },
      { language: "MongoDB", proficiency: 34 },
      { language: "Django", proficiency: 50 },
      { language: "PHP", proficiency: 3 },
      { language: "SQLite", proficiency: 12 },
      { language: "Rust", proficiency: 7 },
      { language: "PyTorch", proficiency: 6 },
      { language: "PostgreSQL", proficiency: 10 },
      { language: "ChatGPT", proficiency: 100 },
    ],
    isOnline: varStatus(),
    location: "Centerton",
...
1. **Using Markdown**: To format code using Markdown, enclose the code within triple backticks (\`\`\`). Specify the programming language after the opening backticks to enable syntax highlighting. For example:
  \`\`\`javascript
  console.log("Hello, world!");
  \`\`\`
2. **Using Forum Tools**: Some forums offer dedicated code formatting buttons. Look for a button that resembles "{ }" or "Code" in the text editor. Click it and paste your code within the designated area.
...
export const projects = [
  ...
  },
  {
    ...
    name: "CodingOH",
    description:
      "CodingOH is a platform where developers can get their questions, specific to their codebase, answered directly. Instead of waiting months for an answer on Stack Overflow, you can simply schedule a call with a fellow developer to get the solution you need. Debugging time will be split into days instead of months now. Yes, this a Stack Overflow alternative, however, it should be seen more as a supplement to good research and problem solving.",
    startDate: new Date("2023-06-20"),
    status: "ongoing",
    stack: ["Next.js", "React", "PostgreSQL", "TypeScript"],
    needed: [
    ...
    github: "https://github.com/jesuschrist-immanuel/stack-overflow-clone",
    image: "",
  },
  {
    id: 26,
    ...
    name: "Edusphere",
    description:
      "It is a nonprofit ed-tech startup streamlining students' academic lives. It will foster school-teacher-student relations by instilling gradebook systems, dynamic transcripts, and class pages. It will also allow students to have accounts to showcase progress in other services (ex: Khan Academy, Duolingo, Brilliant, etc). Also, students can write blurbs every semester to check in on how they utilized their resources, what they have been doing outside of school, how they have been pushing themselves, etc. On the platform itself, there will be a college application portal allowing students to apply to multiple colleges with information already known (ex: name, income, family, activities, etc). Also, EdusphereAI aims to offer AI services at different prices according to a student's family income, with a certain threshold allowing for free AI services. EdusphereAI includes homework help, essay checker, essay assistant, STEM assistant, research assistant, career advisor, and much more.",
  ...
  },
  {
    ...
    owner: users[17],
    name: "Spheres",
    description: `It is a social network/platform that allows users to join and create "spheres." However, rather than posting pictures and videos, the platform is centered around users giving live audio sessions. It's better with an example. Imagine Hillary Clinton going live in her "sphere of influence" and talking about a political issue or Bill Gates discussing climate solutions. These live sessions can also include Q&A and fireside chat integrations. For example, users could "stand" in a virtual queue to ask questions to Drake, or Peter Kafka could be invited into Sam Altman's sphere to host a fireside chat on the future of AI. Along with users being able to listen to influential users' sessions, each sphere will also act like a Discord. I mean that in the sphere, users can chat textually with each other, allowing free discussion on the platform as well. The admin of the sphere can also post textually and automatically pin his or her posts in the sphere. SpheresAI aims to be an innovative force in using AI beneficially in social media. First, SpheresAI will check a user's textual comment even before being posted in the sphere according to the admin's guardrails (if he or she inputted guardrails to follow). This will allow hate speech and misinformation to be mitigated and, at most, hindered. Second, SpheresAI will transform the sphere's owner into an AI avatar if the user chooses to. This will allow members of the sphere to "talk" with the figure at any time. For example, imagine Lex Fridman creating an AI for users to ask questions to about podcasting and machine learning. SpheresAI will train upon a celebrity database to make it easier for influencers and celebrities to create AIs. Third, SpheresAI will allow users to have personal meetings with AIs they choose to create or have. For example, a user could talk to an AI business assistant to discuss to potential business deal that he or she is nervous about or a user could talk to an AI talk therapist who can privately work with the user. Transferred into VR or the metaverse, these AIs can be embodied in human-like appearances.`,
    startDate: new Date("2023-11-19"),
    status: "on_hold",
    github: "www.github.com",
    stack: [
    ...
    image:
      "https://t3.ftcdn.net/jpg/02/20/56/82/360_F_220568237_UlPlJ1yuzpzoX0unw2Ld32CYas35Yows.jpg",
    application: "spheres.com/jobs",
  },
];
...
export const texts = [
  {
    id: 1,
    text: "So, Chandler, have I ever told you about the fascinating world of botany?",
    sender: false,
    replyContent: "",
    reactions: [],
  },
  {
    id: 2,
    text: "Oh, no, you haven’t, Ross. Please, enlighten me.",
    sender: true,
    replyContent:
      "So, Chandler, have I ever told you about the fascinating world of botany?",
    reactions: [],
  },
  {
    id: 3,
    text: "Well, botany is the scientific study of plants! It includes everything from the smallest algae to the tallest trees. Did you know that plants can communicate with each other through their root systems?",
    sender: false,
    replyContent: "",
    reactions: [],
  },
  {
    id: 4,
    text: "Oh, great. Plants are having secret conversations. What next? Will they start texting?",
    sender: true,
    replyContent:
      "Well, botany is the scientific study of plants! It includes everything from the smallest algae to the tallest trees. Did you know that plants can communicate with each other through their root systems?",
    reactions: ["😂"],
  },
  {
    id: 5,
  ...
  {
    id: 6,
    text: "Yeah! And get this—some plants can even produce their own pesticides to protect themselves from predators. Isn’t that incredible?",
    sender: false,
    replyContent: "",
    reactions: [],
  },
  {
    id: 7,
    text: "Incredible? Sure, if you find watching paint dry incredible too.",
    sender: true,
    replyContent:
      "Yeah! And get this—some plants can even produce their own pesticides to protect themselves from predators. Isn’t that incredible?",
    reactions: [],
  },
  {
    id: 8,
    text: "That’s... amazing, Ross.",
    sender: true,
    replyContent: "",
    reactions: [],
  },
  {
    id: 9,
    text: "Oh, and there's something called phototropism. It’s how plants grow towards light. They have specialized cells that can detect the direction of light and guide their growth accordingly. Isn’t nature just brilliant?",
    sender: false,
    replyContent: "",
    reactions: [],
  },
  {
    id: 10,
    text: "Yes, nature is brilliant. And so is my idea of watching TV instead.",
    sender: true,
    replyContent:
      "Oh, and there's something called phototropism. It’s how plants grow towards light. They have specialized cells that can detect the direction of light and guide their growth accordingly. Isn’t nature just brilliant?",
    reactions: [],
  },
  {
    id: 11,
  ...
  {
    id: 12,
    text: "And you know about photosynthesis, right? It’s how plants convert light energy into chemical energy. It’s literally the foundation of life on Earth!",
    sender: false,
    replyContent: "",
    reactions: [],
  },
  {
    id: 13,
    text: "If I close my eyes, will he notice? Maybe if I nod occasionally...",
    sender: true,
    replyContent:
      "And you know about photosynthesis, right? It’s how plants convert light energy into chemical energy. It’s literally the foundation of life on Earth!",
    reactions: [],
  },
  {
    id: 14,
    text: "Absolutely. The foundation of life. Amazing stuff, Ross.",
    sender: true,
    replyContent: "",
    reactions: [],
  },
  {
    id: 15,
    text: "Oh, I could go on for hours about plant biology. Did you know that some plants can even eat insects? Like the Venus flytrap!",
    sender: false,
    replyContent: "",
    reactions: [],
  },
  {
    id: 16,
    text: "Hours? Oh, no. Please, let this end soon. Venus flytrap? Now that's slightly interesting...if it eats this conversation.",
    sender: true,
    replyContent:
      "Oh, I could go on for hours about plant biology. Did you know that some plants can even eat insects? Like the Venus flytrap!",
    reactions: [],
  },
  {
    id: 17,
    text: "Wow, insect-eating plants. That’s, um, really cool.",
    sender: true,
    replyContent: "",
    reactions: [],
  },
  {
    id: 18,
    text: "Right? And there's so much more. Like, there are plants that can survive in extreme environments—deserts, arctic tundras, even underwater!",
    sender: false,
    replyContent: "",
    reactions: [],
  },
  {
    id: 19,
    text: "Underwater plants. Great. Now I’m drowning in boredom.",
    sender: true,
    replyContent:
      "Right? And there's so much more. Like, there are plants that can survive in extreme environments—deserts, arctic tundras, even underwater!",
    reactions: [],
  },
  {
    id: 20,
    text: "Fascinating. Truly fascinating, Ross.",
    sender: true,
    replyContent: "",
    reactions: [],
  },
  {
    id: 21,
    text: "I’m glad you’re enjoying this, Chandler. Botany is just so underrated, don’t you think?",
    sender: false,
    replyContent: "",
    reactions: [],
  },
  {
    id: 22,
    text: "Oh, it’s definitely rated...as the perfect cure for insomnia.",
    sender: true,
    replyContent:
      "I’m glad you’re enjoying this, Chandler. Botany is just so underrated, don’t you think?",
    reactions: [],
  },
  {
    id: 23,
    text: "Absolutely, Ross. Totally underrated.",
    sender: true,
    replyContent: "",
    reactions: [],
  },
  {
    id: 24,
    text: "Maybe we should go visit the botanical gardens sometime. I can show you all these plants in person!",
    sender: false,
    replyContent: "",
    reactions: [],
  },
  {
    id: 25,
    text: "Botanical gardens? Is there an escape route?",
    sender: true,
    replyContent:
      "Maybe we should go visit the botanical gardens sometime. I can show you all these plants in person!",
    reactions: [],
  },
  {
    id: 26,
    text: "Uh, yeah, sure, Ross. That sounds like a...great idea.",
    sender: true,
    replyContent: "",
    reactions: [],
  },
  {
    id: 27,
    text: "Awesome! I’ll set it up. You’re gonna love it.",
    sender: false,
    replyContent: "",
    reactions: [],
  },
  {
    id: 28,
    text: "Oh, joy. I can’t wait.",
    sender: true,
    replyContent: "Awesome! I’ll set it up. You’re gonna love it.",
    reactions: [],
  },
  {
    id: 29,
    text: "Can’t wait, Ross. Really.",
    sender: true,
    replyContent: "",
    reactions: [],
  },
